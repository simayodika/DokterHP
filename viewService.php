    ...
    <div class="container my-2">
        <div class="row">
            ...
            <div class="col-md-10">
                 <div class="card mt-2">
                    <div class="col-md-6">
                        <a href="tambahService.php" class="btn btn-info font-weight-bold"> Tambah Service</a>
                    </div>
                    <table class="table table-stripped table-hover">
                        ...
                        $no = $posisi+1;
                        $sql="SELECT * FROM service  ORDER BY id_service  desc limit $posisi,$batas";
                        ...
                        while ($data = mysqli_fetch_array($hasil)) {
                            ...
                            <tr>
                                ...
                                <td><a href="deleteService.php?id=<?php echo $data['id_service']; ?>
                                    " onclick="return confirm('Apakah anda yakin menghapus?')">Delete </a> |
                                    <a href="editService.php?id=<?php echo $data['id_service']; ?>">Update</a><?php } ?>
                                  </td>
